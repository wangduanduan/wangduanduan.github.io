...
![](https://wdd-images.oss-cn-shanghai.aliyuncs.com/20180208094439_zGRL80_Screenshot.jpeg)

# 1. Audio
通过打开谷歌浏览器的dev tools -> Settings -> Elements -> Show user agent shadow DOM, 你可以看到其实Audio标签也是由常用的 input标签和div等标签合成的。

![](https://wdd-images.oss-cn-shanghai.aliyuncs.com/20180208094451_tBBQUM_Screenshot.jpeg)
...
![](https://wdd-images.oss-cn-shanghai.aliyuncs.com/20180208094513_MO2e9z_Screenshot.jpeg)
...
![](https://wdd-images.oss-cn-shanghai.aliyuncs.com/20180208094523_k82xlG_Screenshot.jpeg)
